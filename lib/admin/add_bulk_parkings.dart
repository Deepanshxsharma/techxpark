...
Future<void> main() async {
  ...
  developer.log("Uploading 50 parking locations...", name: 'seed_parkings');
  ...
  for (var p in parkings) {
    await ref.add(p);
    developer.log("Added: ${p['name']}", name: 'seed_parkings');
  }

  developer.log(
    "DONE - All 50 parkings uploaded successfully!",
    name: 'seed_parkings',
  );
}
