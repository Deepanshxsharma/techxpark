...
class _ParkingTimerScreenState extends State<ParkingTimerScreen> {
  ...
  // Theme
  static const Color _techBlue = AppColors.primary;
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    "Choose how long to extend your parking.",
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    "New end: ${DateFormat('hh:mm a').format(newTime)}",
        ...
        builder: (ctx) => AlertDialog(
          ...
          actions: [
            TextButton(
              ...
              child: const Text(
                'OK',
                style: TextStyle(color: _techBlue, fontWeight: FontWeight.w700),
              ),
            ),
          ],
        ),
      ...
      builder: (ctx) => AlertDialog(
        ...
        actions: [
          ...
          TextButton(
            ...
            child: const Text(
              'Cancel Booking',
              style: TextStyle(color: _alertRed, fontWeight: FontWeight.w700),
            ),
          ),
        ],
      ),
  ...
  Future<void> _performCancel() async {
    ...
    try {
      final msg = await _repo.cancelBooking(bookingId: widget.bookingId);
      if (mounted) Navigator.pop(context); // dismiss loading
      ...
      if (mounted) {
        ScaffoldMessenger.of(
          context,
        ).showSnackBar(SnackBar(content: Text(msg), backgroundColor: _success));
  ...
  Widget build(BuildContext context) {
    ...
    final displayColor = _isCancelled
        ? Colors.grey
        : (isExpired ? _alertRed : _techBlue);
    ...
    final totalDuration = _end.difference(widget.start.toUtc()).inSeconds;
