...
class InfrastructurePainter {
  ...
  static void drawInfrastructure(Canvas canvas, Size size) {
    ...
    _drawBoomBarrier(
      canvas,
      const Offset(ParkingMapConfig.mapW / 2 - 40, ParkingMapConfig.mapH - 25),
      true,
    ); // Entry
    _drawBoomBarrier(
      canvas,
      const Offset(ParkingMapConfig.mapW - 60, ParkingMapConfig.mapH - 25),
      false,
    ); // Exit
    ...
    _drawZebraCrossing(
      canvas,
      const Offset(ParkingMapConfig.mapW / 2 - 20, ParkingMapConfig.mapH - 60),
    );
  ...
  static void _drawBoomBarrier(Canvas canvas, Offset center, bool isEntry) {
    ...
    canvas.drawLine(center, Offset(center.dx + 40, center.dy - 10), armPaint);
  }
  ...
  static void _drawElevator(Canvas canvas, Offset center) {
    ...
    // Split doors
    canvas.drawRect(
      Rect.fromLTWH(rect.left + 2, rect.top + 2, 17, 36),
      doorPaint,
    );
    canvas.drawRect(
      Rect.fromLTWH(rect.left + 21, rect.top + 2, 17, 36),
      doorPaint,
    );
  }
}
