          ...
          Expanded(
            child: StreamBuilder<QuerySnapshot>(
              ...
              builder: (context, snapshot) {
                ...
                if (slots.isEmpty) return Center(child: Text("No slots found", style: TextStyle(color: Colors.white54)));
                  ...
                  itemBuilder: (context, rowIndex) {
                    ...
                    return Container(
                      ...
                      child: Row(
                        children: [
                          // Left Bay
                          Expanded(child: leftIndex < slots.length 
                              ? _buildSlot(slots[leftIndex]) : const SizedBox()),
                          ...
                          // Right Bay
                          Expanded(child: rightIndex < slots.length 
                              ? _buildSlot(slots[rightIndex]) : const SizedBox()),
                        ],
                      ),
                    );
                  },
    ...
    return Container(
      ...
      child: Stack(
        ...
        children: [
          ...
          Positioned(
            bottom: 4,
            child: Text(name, style: const TextStyle(color: Colors.white60, fontSize: 10)),
          ),
          
          // Car or Free Icon
          isTaken
              ? Icon(Icons.directions_car, color: _occupiedRed, size: 30)
              : Text("FREE", style: TextStyle(color: _freeGreen, fontWeight: FontWeight.bold, fontSize: 12)),
          ...
          if (isLive)
            Positioned(
              ...
              child: Container(
                width: 6, height: 6,
                decoration: BoxDecoration(color: isTaken ? _occupiedRed : _freeGreen, shape: BoxShape.circle, boxShadow: [BoxShadow(color: isTaken ? _occupiedRed : _freeGreen, blurRadius: 6)]),
              ),
            )
        ],
      ),
