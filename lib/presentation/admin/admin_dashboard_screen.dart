...
class _AdminDashboardScreenState extends State<AdminDashboardScreen> with SingleTickerProviderStateMixin {
        ...
        slivers: [
          ...
          SliverAppBar(
            ...
            flexibleSpace: FlexibleSpaceBar(
              ...
              title: Text(
                "Admin Console",
                style: TextStyle(color: _darkHeader, fontWeight: FontWeight.w900, fontSize: 22),
              ),
            ),
            actions: [
              Padding(
          ...
          SliverPadding(
            ...
            sliver: SliverList(
              delegate: SliverChildListDelegate([
                ...
                Row(
                  children: [
                    ...
                    Expanded(
                      child: _buildGradientStatCard(
                        "Live Bookings",
                        FirebaseFirestore.instance.collection("bookings").where("endTime", isGreaterThan: Timestamp.now()).snapshots(),
                ...
                Text("Management", style: TextStyle(color: Colors.grey.shade600, fontSize: 14, fontWeight: FontWeight.w700, letterSpacing: 1.2)),
  ...
  Widget _buildDateHeader() {
    ...
    return Column(
      ...
      children: [
        Text(DateFormat('EEEE, d MMMM').format(now).toUpperCase(), style: TextStyle(color: Colors.grey.shade500, fontSize: 12, fontWeight: FontWeight.w700, letterSpacing: 1.5)),
        const SizedBox(height: 5),
        Row(
          children: [
            Text("Overview", style: TextStyle(color: _darkHeader, fontSize: 28, fontWeight: FontWeight.w800)),
            const SizedBox(width: 8),
            Container(width: 8, height: 8, decoration: BoxDecoration(color: _primaryBlue, shape: BoxShape.circle)),
          ],
        ),
      ],
    );
  ...
  Widget _buildGradientStatCard(String title, Stream<QuerySnapshot> stream, IconData icon, List<Color> colors) {
  ...
  Widget _buildAnimatedMenuTile(int index, String title, IconData icon, Color color, VoidCallback onTap) {
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(title, style: TextStyle(color: _darkHeader, fontWeight: FontWeight.w700, fontSize: 16)),
